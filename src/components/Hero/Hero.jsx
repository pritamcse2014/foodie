                ...
                <div className="container pb-8 sm:pb-0">
                    <div className="grid grid-cols-1 sm:grid-cols-2">
                        <div data-aos="zoom-out" data-aos-duration="400" data-aos-once="true" className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1">
                            ...
                            <p className="text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam reprehenderit doloremque earum ut iure id dolorum suscipit ducimus! Nam, excepturi.</p>
                            <div>
                        ...
                        <div className="order-1 sm:order-2 min-h-[450px] sm:min-h-[450px] flex justify-center items-center relative">
                            <div className="flex justify-center items-center h-[300px] sm:h-[450px] overflow-hidden">
                                <img data-aos="zoom-out" data-aos-duration="400" data-aos-once="true" className="w-[300px] sm:w-[450px] mx-auto spin" src={imageId} alt="Image Id" />
                            </div>
